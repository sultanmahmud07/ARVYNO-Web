  ...
  return (
    <section className="py-16 sm:py-20 bg-[#080808]">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="relative rounded-2xl sm:rounded-3xl overflow-hidden border border-[#c9a227]/30 shadow-2xl bg-[#0a0a0a] min-h-[480px] sm:min-h-[520px] lg:min-h-[560px] flex flex-col justify-between group">
          
          {/* Background Image Layer — Right side visible clearly, left side dissolves into black */}
          <div className="absolute inset-0 z-0">
            ...
            {/* Smart Gradient Overlay: Deep solid dark on the left, smooth slow fade in the middle, crystal clear on the right */}
          ...
          <div className="relative z-10 max-w-xl sm:max-w-2xl p-6 sm:p-10 lg:p-14 space-y-6 sm:space-y-7 my-auto">
            ...
            <div className="pt-2 flex flex-col sm:flex-row items-stretch sm:items-center gap-4">
              <Link
                ...
                className="px-8 py-4 bg-gradient-to-r from-[#c9a227] via-[#e5c76b] to-[#c9a227] hover:brightness-110 active:scale-[0.98] text-black font-bold text-xs uppercase tracking-[0.2em] rounded-xl transition-all shadow-xl shadow-[#c9a227]/15 flex items-center justify-center gap-2.5 group/btn"
              >
          ...
          {/* Bottom Feature Pillars Bar (PREMIUM • BREATHABLE • DURABLE • VERSATILE) */}
            ...
            <div className="grid grid-cols-2 sm:grid-cols-4 divide-x divide-white/10">
              {FEATURE_PILLARS.map((pillar) => {
                ...
                return (
                  <div
                    key={pillar.label}
                    className="flex items-center justify-center gap-2.5 py-4 px-3 sm:px-4 text-center hover:bg-white/5 transition-colors"
                  >
                    <div className="w-7 h-7 rounded-full border border-[#c9a227]/30 bg-[#c9a227]/10 flex items-center justify-center text-[#e5c76b] flex-shrink-0">
                      <PillarIcon className="w-3.5 h-3.5" />
                    </div>
                    <span className="font-sans text-[11px] sm:text-xs font-bold tracking-[0.2em] uppercase text-[#f8f8f6]">
                      {pillar.label}
                    </span>
                  </div>
                );
