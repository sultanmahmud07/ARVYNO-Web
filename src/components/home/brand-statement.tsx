...
export function BrandStatement() {
  return (
    <section className="py-24 bg-[#080808] relative overflow-hidden">
      ...
      <div className="absolute top-1/2 left-0 -translate-y-1/2 w-96 h-96 bg-[#c9a227]/5 rounded-full blur-[120px] pointer-events-none animate-pulse-glow" />
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 lg:gap-16 items-center">
          ...
          <div className="lg:col-span-6">
            <ScrollReveal direction="right" duration={700}>
              <div className="relative aspect-[4/5] sm:aspect-square lg:aspect-[4/5] rounded-2xl overflow-hidden border border-[#c9a227]/30 shadow-2xl bg-[#141414] group hover:border-[#c9a227]/50 transition-all">
                <Image
                ...
                <div className="absolute bottom-6 left-6 right-6 p-4 glass-card rounded-xl border border-white/10 shadow-lg">
          ...
          <div className="lg:col-span-6 space-y-8 text-center lg:text-left">
            <ScrollReveal direction="left" delay={100} duration={650}>
              <div className="space-y-3">
                ...
                <h2 className="font-serif text-3xl sm:text-4xl lg:text-5xl font-bold tracking-tight text-[#f8f8f6] leading-[1.15]">
                  ...
                  <span className="gold-text-gradient font-extrabold">IT&apos;S YOUR IDENTITY.</span>
                </h2>
              </div>
            </ScrollReveal>
            ...
            <div className="space-y-4 pt-2">
              <ScrollReveal direction="left" delay={300} duration={500}>
                <div className="flex items-start gap-3.5 text-left group">
                  <div className="p-1.5 rounded-full bg-[#c9a227]/15 text-[#c9a227] border border-[#c9a227]/30 flex-shrink-0 mt-0.5 group-hover:scale-110 group-hover:bg-[#c9a227] group-hover:text-black transition-all">
              ...
              <ScrollReveal direction="left" delay={400} duration={500}>
                <div className="flex items-start gap-3.5 text-left group">
                  <div className="p-1.5 rounded-full bg-[#c9a227]/15 text-[#c9a227] border border-[#c9a227]/30 flex-shrink-0 mt-0.5 group-hover:scale-110 group-hover:bg-[#c9a227] group-hover:text-black transition-all">
                    <Check className="w-4 h-4" />
                  </div>
              ...
              <ScrollReveal direction="left" delay={500} duration={500}>
                <div className="flex items-start gap-3.5 text-left group">
                  <div className="p-1.5 rounded-full bg-[#c9a227]/15 text-[#c9a227] border border-[#c9a227]/30 flex-shrink-0 mt-0.5 group-hover:scale-110 group-hover:bg-[#c9a227] group-hover:text-black transition-all">
                    <Check className="w-4 h-4" />
                  </div>
            ...
            <ScrollReveal direction="left" delay={600} duration={550}>
              <div className="pt-4 flex flex-col sm:flex-row items-center justify-center lg:justify-start gap-4">
                <Link
                  href="/about"
                  className="px-8 py-3.5 bg-[#161616] hover:bg-[#202020] text-[#f8f8f6] hover:text-[#c9a227] border border-[#2d2d2d] hover:border-[#c9a227]/40 rounded-xl font-semibold text-xs uppercase tracking-widest transition-all flex items-center gap-2 group shadow-md"
                >
