...
export function FeaturedCategories() {
  const catHoodies = CATEGORIES.find((c) => c.slug === "hoodies") || CATEGORIES[0];
  const catDrop = CATEGORIES.find((c) => c.slug === "drop-shoulder") || CATEGORIES[1];
  const catBaggy = CATEGORIES.find((c) => c.slug === "baggy-pants") || CATEGORIES[2];
  const catAcid = CATEGORIES.find((c) => c.slug === "acid-wash") || CATEGORIES[3];
  ...
  return (
    <section className="py-20 sm:py-24 bg-[#0a0a0a] border-y border-[#181818] relative overflow-hidden">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
          ...
          <div className="flex flex-col md:flex-row md:items-end justify-between gap-6 mb-12">
            <div className="space-y-2 max-w-2xl">
              ...
              <p className="text-xs sm:text-sm text-[#888888] leading-relaxed pt-1">
                Explore signature drops: 350+ GSM Heavyweight Hoodies, 220+ GSM Drop Shoulder Tees, Premium Interlock Baggy Pants, and Artisanal Acid Wash.
              </p>
            </div>
        ...
        {/* Bento / Asymmetric Luxury Editorial Grid Layout (4 Core Categories) */}
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-5 lg:gap-6">

          {/* 1. Large Hero Bento Card (Left Column - Heavyweight Hoodies) */}
          ...
          {/* Right Column Bento Cards (Drop Shoulder + Baggy Pants + Acid Wash) */}
          <div className="lg:col-span-7 flex flex-col justify-between gap-5 lg:gap-6">

            {/* 2. Wide Top Card (Drop Shoulder T-Shirts) */}
            ...
            {/* 3 & 4. Bottom 2-Column Split Cards (Baggy Pants & Acid Wash) */}
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-5 lg:gap-6">

              {/* Card 3: Premium Baggy Pants */}
              <ScrollReveal direction="up" delay={250} duration={700}>
                <Link
                  href={`/categories/${catBaggy.slug}`}
                ...
                >
                  ...
                  <div className="relative z-10 space-y-1.5">
                    ...
                    <p className="text-xs text-[#a0a0a0] line-clamp-1 font-light">
                      From {catBaggy.startingPrice ? formatPrice(catBaggy.startingPrice) : "৳720"} • Interlock Fabric & Metal Tips
                    </p>
              ...
              <ScrollReveal direction="up" delay={350} duration={700}>
                ...
                >
                  ...
                  <div className="relative z-10 space-y-1.5">
                    ...
                    <p className="text-xs text-[#a0a0a0] line-clamp-1 font-light">
                      From {catAcid.startingPrice ? formatPrice(catAcid.startingPrice) : "৳699"} • Mineral Acid Wash
                    </p>
                    <div className="pt-2 flex items-center justify-between text-xs text-[#e5c76b] font-semibold uppercase tracking-wider group-hover:text-white transition-colors">
